...
#define myOSCCAL *((volatile unsigned char* const)0X51)//oscillator
#define myOCDR   *((volatile unsigned char* const)0X51)//on chip debugger (j tag)
...
#define myWDTCR  *((volatile unsigned char* const)0X41)//watch dog
